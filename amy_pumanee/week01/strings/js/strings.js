...
var i = 1000000;
if (i < 1000000) {
  console.log(`DrEvil ${i} : ${i} dollars`);
}
else if (i = 1000000) {
  console.log(`DrEvil ${i} : ${i} dollars (pinky)`);
}
...
*/
  let txt = (mix, pod); {
  //console.log(`mixUp ${string.5} + ${string.6} + ${string.0}: '`);
  console.log(`mixUp ${txt.charAt(5)} + ${txt.charAt(6)}`);
}
