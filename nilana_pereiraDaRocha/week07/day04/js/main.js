...
let numbersRandomMin = _.random(numbers, function (number) { return number.min });
let numbersRandomMax = _.random(numbers, function (number) { return number.max });
console.log(numbersRandomMin);
console.log(numbersRandomMax);
